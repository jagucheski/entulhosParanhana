...
import br.com.entulhosParanhana.uteis.PasswordValidate;
...
public class CadUsuarioManagedBean implements Serializable {
	...
	static final Logger logger = Logger.getLogger("br.com.entulhosParanhana.controller.CadUsuarioManagedBean");
