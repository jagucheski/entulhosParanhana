...
public class UsuarioDao {
	...
	/***
	 * METODO RESPONSÁVEL POR VALIDAR O USUARIO INFORMADO NO LOGIN
	 * 
	 * @param usuario
	 */
	...
	/***
	 * METODO USADO PARA PESQUISAR USUARIO POR CPF QUE SERÁ UTILIZADO PARA VALIDAR CPF NÁO DEIXANDO TER DOIS CPF IGUAIS NA BASE
	 * 
	 * @param usuario
	 */
